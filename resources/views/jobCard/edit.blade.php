        ...
        <div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Edit Job Card</div>
                ...
                <form role="form" method="POST" action="{{ route('jobCard.update',$jobCard->id) }}"
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" disabled readonly name="job_id"
                                       ...
                                       placeholder="Vehicle Number" value="{{ $jobCard->job_id}}"/>
                                @error('job_id')
                            ...
                            <div class="col-sm-9">
                               <div class="relative">
                                <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                                    ...
                                    <input required datepicker datepicker-format="yyyy/mm/dd" type="text" id="received_date" name="received_date" value="{{ $jobCard->received_date }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Received Date">
                                </div>
                                @error('received_date')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="nature_of_repair"
                                       class="form-control   @error('nature_of_repair') is-invalid @enderror" id="nature_of_repair" value="{{ $jobCard->nature_of_repair }}">
                                @error('name')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="job_date_count"
                                       ...
                                       placeholder="Assueme Date Count" value="{{ $jobCard-> job_date_count}}">
                                @error('name')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="wd_no"
                                       ...
                                       placeholder="Ward Number" value="{{ $jobCard->wd_no }}">
                                @error('name')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="relative">
                                ...
                                <input required datepicker datepicker-format="yyyy/mm/dd" type="text" id="in_inspect_date" name="in_inspect_date" value="{{ $jobCard->in_inspect_date }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="In Inspect Date">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="relative">
                                ...
                                <input required datepicker datepicker-format="yyyy/mm/dd" type="text" id="work_start_date" name="work_start_date" value="{{ $jobCard->work_start_date}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Work Start Date">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="relative">
                                    ...
                                    <input required datepicker datepicker-format="yyyy/mm/dd" type="text" id="work_end_date" name="work_end_date" value="{{ $jobCard->work_end_date }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Work End Date">
                                </div>
                                @error('work_end_date')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="mileage"
                                       ...
                                       placeholder="Mileage" value="{{ $jobCard->mileage }}">
                                @error('mileage')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input required datepicker datepicker-format="yyyy/mm/dd" type="text" id="delivery_date" name="delivery_date" value="{{ $jobCard->delivery_date }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Delivery Date">
                            </div>
                                @error('delivery_date')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="repair_req"
                                       ...
                                       placeholder="Repair Required" value="{{ $jobCard->repair_req }}">
                                @error('repair_req')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
...
{{--                                                <option selected value=""></option>--}}
                                        ...
                                        <td>
                                            @foreach($vehicle_tcategories as $tcategory)
                                                <input type="text" name="qty[]" class="form-control" id="qty" value="{{$tcategory->qty}}">{{$tcategory->qty}}</td>
                                            @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="relative">
                                ...
                                <input required datepicker datepicker-format="yyyy/mm/dd" type="text" id="out_inspect_date" name="out_inspect_date" value="{{ $jobCard->out_inspect_date }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Out Inspect Date">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="store_req"
                                       ...
                                       placeholder="Stores Required" value="{{ $jobCard->store_req }}">
                                @error('store_req')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="voucher_serial_no"
                                       ...
                                       placeholder="Voucher Serial Number" value="{{ $jobCard->voucher_serial_no }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="relative">
                                ...
                                <input required datepicker datepicker-format="yyyy/mm/dd" type="text" id="date_req" name="date_req" value="{{ $jobCard->date_req }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Product Request Date">
                            </div>
                                @error('date_req')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="relative">
                                ...
                                <input required datepicker datepicker-format="yyyy/mm/dd" type="text" id="date_rev" name="date_rev" value="{{ $jobCard->date_rev }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Product Received Date">
                            </div>
                                @error('date_rev')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
