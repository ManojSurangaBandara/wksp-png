...
class UnitDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($item) {
                return '<div class="w-80"></div><a href="' . route('unit.show', $item->id) . '" class="btn btn-xs btn-warning"><i class="fa fa-eye"></i></a>
                 </div>';
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('regiment.name')->title("Relevent Regiment"),
